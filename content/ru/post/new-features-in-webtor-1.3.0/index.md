---
title: "Автопереключение тёмной темы и доступ для спонсоров — Webtor 1.3.0"
description: "Тёмная и светлая темы с автопереключением, дополнительные возможности для спонсоров и первые шаги к открытию исходного кода Webtor."
