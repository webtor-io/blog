---
title: "Дозагрузка после обрыва и drag-and-drop субтитров — Webtor 1.13.0"
description: "Дозагрузка файлов после обрыва, вечное хранение торрент-файлов, drag-and-drop субтитров в плеер и удобный интерфейс на мобильных устройствах."
