---
title: "Конвертация видео для мобильных и ускоренный HLS — Webtor 1.12.0"
description: "Популярное видео теперь заранее конвертируется в форматы для мобильных устройств, а закэшированные HLS-фрагменты подгружаются с опережением."
