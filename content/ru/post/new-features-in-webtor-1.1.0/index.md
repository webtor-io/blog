---
title: "Плеер под выбранным файлом и ссылки на поток для VLC — Webtor 1.1.0"
description: "Плеер открывается сразу под выбранным файлом, ссылку на поток можно вставить в VLC, а скрипты стали в 3 раза легче — обновление Webtor 1.1.0."
