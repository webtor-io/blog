---
title: "Мгновенное переключение аудиодорожек, поддержка .ts и .vob — Webtor 1.9.0"
description: "Моментальное переключение аудиодорожек без перезапуска видео, поддержка форматов .ts и .vob и более плавное воспроизведение за счёт кэша."
