---
title: "SDK плеера для встраивания видео на любой сайт — Webtor 1.7.0"
description: "SDK плеера для встраивания торрент-видео на любой сайт, удобный выбор субтитров с настройкой размера и тёмная тема по умолчанию в Webtor 1.7.0."
